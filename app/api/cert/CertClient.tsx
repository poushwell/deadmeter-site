...
export function CertClient() {
  ...
  async function handleNotifySubmit() {
    if (!notifyEmail.trim()) return; // cert_hash may be null while processing — send anyway
    try {
                    ...
                    {notifySent ? (
                      ...
                      >
                        <input
                          ...
                          required
                          className="flex-1 border border-[var(--border)] border-r-0 bg-[var(--paper)] px-4 py-3 text-[15px] font-mono text-[var(--text-primary)] placeholder:text-[var(--text-tertiary)] focus:outline-none focus:border-[var(--text-primary)]"
                        />
                        <button
                          type="submit"
                  ...
                  {mode === 'text' && (
                    <div id="tab-panel-text" role="tabpanel" aria-label="Text input">
                      ...
                      <textarea
                        ...
                        rows={14}
                        className="w-full border border-[var(--border)] bg-[var(--bg)] px-4 py-3 text-[15px] font-mono text-[var(--text-primary)] placeholder:text-[var(--text-tertiary)] resize-y leading-[1.60] focus:outline-none focus:border-[var(--text-primary)] mb-3"
                  ...
                  {mode === 'url' && (
                    <div id="tab-panel-url" role="tabpanel" aria-label="URL input">
                      ...
                      <input
                        ...
                        className="w-full border border-[var(--border)] bg-[var(--bg)] px-4 py-3 text-[15px] font-mono text-[var(--text-primary)] placeholder:text-[var(--text-tertiary)] focus:outline-none focus:border-[var(--text-primary)]"
